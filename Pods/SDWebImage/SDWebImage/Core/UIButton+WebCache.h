 ...
 *
 * @param state Which state you want to know the URL for. The values are
 ...
 * @param state The state that uses the specified title. The values are
 * described in UIControlState.
 */
...
/**
 * Set the button `image` with an `url`, placeholder, custom options and
 * context.
 *
 * The download is asynchronous and cached.
 *
...
/**
 * Set the button `backgroundImage` with an `url`, placeholder and custom
 * options.
 *
 * The download is asynchronous and cached.
 *
...
/**
 * Set the button `backgroundImage` with an `url`, placeholder, custom options
 * and context.
 *
 * The download is asynchronous and cached.
 *
...
- (void)sd_setBackgroundImageWithURL:(nullable NSURL *)url
                    ...
                    placeholderImage:(nullable UIImage *)placeholder
                           completed:(nullable SDExternalCompletionBlock)
                                         completedBlock NS_REFINED_FOR_SWIFT;
