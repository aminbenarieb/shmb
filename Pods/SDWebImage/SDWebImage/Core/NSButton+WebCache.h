 ...
 * In case of error the image parameter is nil and the second parameter may
 * contain an NSError. The third parameter is a Boolean indicating if the image
 * was retrieved from the local cache or from the network. The fourth parameter
 * is the original image url.
 */
- (void)sd_setImageWithURL:(nullable NSURL *)url
 ...
 *
 * @param url         The url for the alternateImage.
 * @param placeholder The alternateImage to be set initially, until the
 * alternateImage request finishes.
...
/**
 * Set the button `alternateImage` with an `url`, placeholder and custom
 * options.
 *
 * The download is asynchronous and cached.
 *
 ...
 * @param placeholder The alternateImage to be set initially, until the
 * alternateImage request finishes.
 * @param options     The options to use when downloading the alternateImage.
 * @see SDWebImageOptions for the possible values.
 */
- (void)sd_setAlternateImageWithURL:(nullable NSURL *)url
                   placeholderImage:(nullable UIImage *)placeholder
                            options:(SDWebImageOptions)options
...
/**
 * Set the button `alternateImage` with an `url`, placeholder, custom options
 * and context.
 *
 * The download is asynchronous and cached.
 *
 ...
 * @param completedBlock A block called when operation has been completed. This
 * block has no return value and takes the requested UIImage as first parameter.
 * In case of error the alternateImage parameter is nil and the second parameter
 * may contain an NSError. The third parameter is a Boolean indicating if the
 * alternateImage was retrieved from the local cache or from the network. The
 * fourth parameter is the original alternateImage url.
 */
- (void)sd_setAlternateImageWithURL:(nullable NSURL *)url
