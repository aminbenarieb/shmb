...
/**
 ...
 We can use a block to specify the cache serializer. But Using protocol can make
...
- (nonnull instancetype)initWithBlock:
    (nonnull SDWebImageCacheSerializerBlock)block;
+ (nonnull instancetype)cacheSerializerWithBlock:
    (nonnull SDWebImageCacheSerializerBlock)block;
