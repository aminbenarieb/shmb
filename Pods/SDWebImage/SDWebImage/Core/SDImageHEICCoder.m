...
// These constants are available from iOS 13+ and Xcode 11. This raw value is
// used for toolchain and firmware compatibility
...
static NSString *kSDCGImagePropertyHEICSUnclampedDelayTime =
    @"UnclampedDelayTime";
