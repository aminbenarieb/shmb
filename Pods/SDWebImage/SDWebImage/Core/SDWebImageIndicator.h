...
/// These indicator use the system style, supports dark mode if available (iOS
/// 13+/macOS 10.14+) large activity indicator
@property(nonatomic, class, nonnull, readonly)
...
/**
 Convenience way to create progress indicator. Remember to specify the indicator
 width or use layout constraint if need.
 */
...
@property(nonatomic, class, nonnull, readonly)
    SDWebImageProgressIndicator *barIndicator API_UNAVAILABLE(macos, tvos);
