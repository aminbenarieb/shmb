...
static NSString *const SDAlternateImageOperationKey =
...
- (void)sd_setImageWithURL:(nullable NSURL *)url
  ...
  [self sd_internalSetImageWithURL:url
                  placeholderImage:placeholder
                     ...
                     setImageBlock:nil
                          progress:progressBlock
                         completed:^(NSImage *_Nullable image,
...
- (void)sd_setAlternateImageWithURL:(nullable NSURL *)url {
  [self sd_setAlternateImageWithURL:url
                   placeholderImage:nil
                            options:0
                           progress:nil
                          completed:nil];
...
- (void)sd_setAlternateImageWithURL:(nullable NSURL *)url
  ...
  [self sd_internalSetImageWithURL:url
      ...
      progress:progressBlock
      completed:^(NSImage *_Nullable image, NSData *_Nullable data,
...
- (void)setSd_currentImageURL:(NSURL *)sd_currentImageURL {
  objc_setAssociatedObject(self, @selector(sd_currentImageURL),
                           sd_currentImageURL,
...
- (void)setSd_currentAlternateImageURL:(NSURL *)sd_currentAlternateImageURL {
  objc_setAssociatedObject(self, @selector(sd_currentAlternateImageURL),
