...
#endif
    _imageTable = [NSMapTable mapTableWithKeyOptions:NSPointerFunctionsCopyIn
...
- (NSString *)getPathForName:(NSString *)name
  ...
  if (providedScale != 0) {
    NSString *scaledName =
        [name stringByAppendingFormat:@"@%@x", @(providedScale)];
