...
extension PersistentStoreStocksInfoCoreDataImpl: PersistentStoreStocksInfo {
    ...
    var isFavourite: Bool? {
        self.isFavouriteNumber?.boolValue
    }
}
...
extension PersistentStoreCoreDataImpl: PersistentStore {
    func watch(stocksInfo _: PersistentStoreStocksInfo) -> AnyPublisher<Bool, Error> {
        // assert not already added
        // add to watch list
        fatalError("Not implemented")
    }

    func unwatch(stocksInfo _: PersistentStoreStocksInfo) -> AnyPublisher<Bool, Error> {
        // assert is exist
        // remove from watch list
        fatalError("Not implemented")
    }

    func favourite(stocksInfo _: PersistentStoreStocksInfo) -> AnyPublisher<Bool, Error> {
        // assert is exist
        // mark as favourite
        fatalError("Not implemented")
    }

    func unfavourite(stocksInfo _: PersistentStoreStocksInfo) -> AnyPublisher<Bool, Error> {
        // assert is exist
        // mark as unfavourite
        fatalError("Not implemented")
    }
